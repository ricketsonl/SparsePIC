...
"""
import numpy as np
import PICES2D_Exp_Clean as PIC2DFG
import time
...
## Build PIC object ##
schimp = PIC2DFG.PICES2D_Exp_Clean(T,dsizex,dsizey,ncx,ncy,nstep,idatgen,N)
## Set magnetic field ##
schimp.B = 15.
